...
static void _RX_Tasks(void);
static void _TX_Tasks(void);
...
void SYS_Tasks ( void )
{
    ...
    /* Create OS Thread for RX Tasks. */
    xTaskCreate((TaskFunction_t) _RX_Tasks,
                "RX Tasks",
                1024, NULL, 1, NULL);

    /* Create OS Thread for TX Tasks. */
    xTaskCreate((TaskFunction_t) _TX_Tasks,
                "TX Tasks",
                1024, NULL, 1, NULL);
